        ...
        <div class="grid grid-cols-1 grid-rows-1">
            <template x-for="(slide, i) in slides" :key="'content-' + i">
                 <div x-show="current === i" x-cloak
                    ...
                    <div>
                        <p class="hero-content-fade text-xs uppercase tracking-[0.25em] text-emerald-400 font-bold mb-4">{{ $orgName }}</p>
            ...
            <div class="lg:col-span-5 flex flex-col justify-between py-2" data-aos="fade-right">
                <div>
                    <h3 class="text-2xl md:text-3xl font-bold text-slate-800 leading-snug">
                        {{ $orgName }} was established in {{ $settings_values['org_established_year'] ?? '1999' }} as MECOSA, with a single, clear objective: to empower communities to build their own financial futures.
                    </h3>
                    <p class="text-slate-600 mt-6 leading-relaxed">
                        Registered as <strong>RCS 6323</strong> by the Registrar of Cooperative Societies, we are a member-owned financial cooperative dedicated to providing affordable and sustainable financial services.
                    </p>
                ...
                <div class="mt-8 pt-8 border-t border-slate-200/60">
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 rounded-full overflow-hidden bg-slate-100 flex-shrink-0">
                            <!-- User initials -->
                            <div class="w-full h-full bg-emerald-100 text-emerald-800 font-extrabold flex items-center justify-center text-sm">M</div>
                        </div>
                        <div>
                            <p class="text-sm font-bold text-slate-800">{{ $orgName }} Board</p>
...
<section class="py-16 bg-theme-primary text-white" data-aos="fade-up">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center pb-2">
            <div>
                <div class="text-4xl md:text-5xl font-bold mb-2" data-counter-target="20" data-counter-suffix="+">0+</div>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div data-aos="fade-right">
                ...
                <p class="text-sm text-emerald-700 font-semibold mt-1 mb-4">Mubende Employees and Community SACCO Foundation</p>
                <p class="text-slate-600 leading-relaxed">MESAFO is a Non-Profit Organisation established under {{ $orgName }} (MECOSA) to provide Corporate Social Responsibility activities that uplift the social and economic well-being of our members and the communities we serve.</p>
                <div class="mt-8 grid grid-cols-2 gap-4">
                    <div class="bg-white p-4 rounded-xl border border-emerald-100 shadow-sm">
                        ...
                        <h4 class="font-bold text-slate-800 text-sm">Donations</h4>
                        <p class="text-slate-500 text-xs mt-1">Supporting communities in need</p>
                    </div>
                    <div class="bg-white p-4 rounded-xl border border-emerald-100 shadow-sm">
                        <div class="w-10 h-10 bg-emerald-50 rounded-lg flex items-center justify-center mb-3">
                        ...
                        <h4 class="font-bold text-slate-800 text-sm">Capacity Building</h4>
                        <p class="text-slate-500 text-xs mt-1">Skills & knowledge development</p>
                    </div>
                    <div class="bg-white p-4 rounded-xl border border-emerald-100 shadow-sm">
                        <div class="w-10 h-10 bg-emerald-50 rounded-lg flex items-center justify-center mb-3">
                            <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        </div>
                        <h4 class="font-bold text-slate-800 text-sm">Economic Empowerment</h4>
                        <p class="text-slate-500 text-xs mt-1">Building financial independence</p>
                    </div>
                    <div class="bg-white p-4 rounded-xl border border-emerald-100 shadow-sm">
                        <div class="w-10 h-10 bg-emerald-50 rounded-lg flex items-center justify-center mb-3">
                            <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                        </div>
                        <h4 class="font-bold text-slate-800 text-sm">Community Outreach</h4>
                        <p class="text-slate-500 text-xs mt-1">CSR activities for our members</p>
                    </div>
                </div>
            </div>
            <div class="bg-emerald-50 rounded-3xl p-8 md:p-10 text-center border border-emerald-100" data-aos="fade-left">
                <div class="w-20 h-20 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-6">
                    <svg class="w-10 h-10 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>
                </div>
                <h3 class="text-2xl font-extrabold text-emerald-800 font-sans">MESAFO</h3>
                <p class="text-emerald-600 text-sm font-semibold mt-1">Mubende Employees and Community SACCO Foundation</p>
                <p class="text-slate-600 text-sm mt-4 leading-relaxed">A Non-Profit Organisation dedicated to corporate social responsibility, community development, and the welfare of MECOSA members and the greater Mubende community.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="py-24 bg-white relative overflow-hidden" data-aos="fade-up">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16">
            ...
            <h2 class="text-3xl md:text-4xl font-extrabold text-slate-950 mt-3 font-sans">Our Products &amp; Services</h2>
            <p class="text-slate-500 mt-3 max-w-2xl mx-auto">{{ $orgName }} provides a comprehensive range of financial and community services.</p>
        </div>
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <!-- Share Account -->
            <div class="glass-card p-6 rounded-3xl border border-slate-100 flex flex-col" data-aos="fade-up" data-aos-delay="0">
                <div class="w-12 h-12 bg-emerald-50 border border-emerald-100 rounded-2xl flex items-center justify-center mb-4 text-emerald-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                </div>
                <h3 class="font-bold text-slate-800 mb-2 text-base">Share Account</h3>
                <p class="text-slate-600 text-xs leading-relaxed">Build ownership in the SACCO through affordable share purchases and earn annual dividends.</p>
                <a href="{{ route('services') }}" class="text-emerald-700 text-xs font-bold mt-4 inline-block hover:text-emerald-800">Learn More &rarr;</a>
            </div>

            <!-- Free Savings -->
            <div class="glass-card p-6 rounded-3xl border border-slate-100 flex flex-col" data-aos="fade-up" data-aos-delay="50">
                <div class="w-12 h-12 bg-emerald-50 border border-emerald-100 rounded-2xl flex items-center justify-center mb-4 text-emerald-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                </div>
                <h3 class="font-bold text-slate-800 mb-2 text-base">Free Savings</h3>
                <p class="text-slate-600 text-xs leading-relaxed">Flexible everyday savings with no fixed deposit schedule. Save at your own pace.</p>
                <a href="{{ route('services') }}" class="text-emerald-700 text-xs font-bold mt-4 inline-block hover:text-emerald-800">Learn More &rarr;</a>
            </div>

            <!-- Group Savings -->
            <div class="glass-card p-6 rounded-3xl border border-slate-100 flex flex-col" data-aos="fade-up" data-aos-delay="100">
                <div class="w-12 h-12 bg-emerald-50 border border-emerald-100 rounded-2xl flex items-center justify-center mb-4 text-emerald-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                </div>
                <h3 class="font-bold text-slate-800 mb-2 text-base">Group Savings</h3>
                <p class="text-slate-600 text-xs leading-relaxed">Save together as a group and access collective financial benefits and loan facilities.</p>
                <a href="{{ route('services') }}" class="text-emerald-700 text-xs font-bold mt-4 inline-block hover:text-emerald-800">Learn More &rarr;</a>
            </div>

            <!-- Fixed Savings -->
            <div class="glass-card p-6 rounded-3xl border border-slate-100 flex flex-col" data-aos="fade-up" data-aos-delay="150">
                <div class="w-12 h-12 bg-emerald-50 border border-emerald-100 rounded-2xl flex items-center justify-center mb-4 text-emerald-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                </div>
                <h3 class="font-bold text-slate-800 mb-2 text-base">Fixed Savings</h3>
                <p class="text-slate-600 text-xs leading-relaxed">Lock in your savings for a fixed period and enjoy higher interest rates on your deposits.</p>
                <a href="{{ route('services') }}" class="text-emerald-700 text-xs font-bold mt-4 inline-block hover:text-emerald-800">Learn More &rarr;</a>
            </div>

            <!-- Young Dreamers -->
            <div class="glass-card p-6 rounded-3xl border border-slate-100 flex flex-col" data-aos="fade-up" data-aos-delay="200">
                <div class="w-12 h-12 bg-emerald-50 border border-emerald-100 rounded-2xl flex items-center justify-center mb-4 text-emerald-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                </div>
                <h3 class="font-bold text-slate-800 mb-2 text-base">Young Dreamers</h3>
                <p class="text-slate-600 text-xs leading-relaxed">A savings product designed for young people to start building their financial future early.</p>
                <a href="{{ route('services') }}" class="text-emerald-700 text-xs font-bold mt-4 inline-block hover:text-emerald-800">Learn More &rarr;</a>
            </div>

            <!-- Loan Products -->
            <div class="glass-card p-6 rounded-3xl border border-slate-100 flex flex-col" data-aos="fade-up" data-aos-delay="250">
                <div class="w-12 h-12 bg-emerald-50 border border-emerald-100 rounded-2xl flex items-center justify-center mb-4 text-emerald-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                </div>
                <h3 class="font-bold text-slate-800 mb-2 text-base">Loan Products</h3>
                <p class="text-slate-600 text-xs leading-relaxed">Access affordable loans for trade, housing, school fees, emergencies, asset acquisition, and more.</p>
                <a href="{{ route('loan-products') }}" class="text-emerald-700 text-xs font-bold mt-4 inline-block hover:text-emerald-800">View All Loans &rarr;</a>
            </div>

            <!-- MTN & Airtel Merchant Payment -->
            <div class="glass-card p-6 rounded-3xl border border-slate-100 flex flex-col" data-aos="fade-up" data-aos-delay="300">
                <div class="w-12 h-12 bg-emerald-50 border border-emerald-100 rounded-2xl flex items-center justify-center mb-4 text-emerald-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
                </div>
                <h3 class="font-bold text-slate-800 mb-2 text-base">MTN &amp; Airtel Merchant Payment</h3>
                <p class="text-slate-600 text-xs leading-relaxed">Make convenient payments and transactions via MTN Mobile Money and Airtel Money.</p>
                <a href="{{ route('msacco') }}" class="text-emerald-700 text-xs font-bold mt-4 inline-block hover:text-emerald-800">Learn More &rarr;</a>
            </div>

            <!-- Capacity Building -->
            <div class="glass-card p-6 rounded-3xl border border-slate-100 flex flex-col" data-aos="fade-up" data-aos-delay="350">
                <div class="w-12 h-12 bg-emerald-50 border border-emerald-100 rounded-2xl flex items-center justify-center mb-4 text-emerald-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                </div>
                <h3 class="font-bold text-slate-800 mb-2 text-base">Capacity Building</h3>
                <p class="text-slate-600 text-xs leading-relaxed">Financial literacy training, entrepreneurship skills, and capacity development for members.</p>
                <a href="{{ route('about') }}" class="text-emerald-700 text-xs font-bold mt-4 inline-block hover:text-emerald-800">Learn More &rarr;</a>
            </div>

            <!-- Donations & Economic Empowerment -->
            <div class="glass-card p-6 rounded-3xl border border-slate-100 flex flex-col" data-aos="fade-up" data-aos-delay="400">
                <div class="w-12 h-12 bg-emerald-50 border border-emerald-100 rounded-2xl flex items-center justify-center mb-4 text-emerald-600">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>
                </div>
                <h3 class="font-bold text-slate-800 mb-2 text-base">Donations &amp; Economic Empowerment</h3>
                <p class="text-slate-600 text-xs leading-relaxed">Community outreach through donations and economic empowerment programs via MESAFO.</p>
                <a href="{{ route('about') }}" class="text-emerald-700 text-xs font-bold mt-4 inline-block hover:text-emerald-800">Learn More &rarr;</a>
            </div>
        </div>
    </div>
...
<section class="py-20 bg-white relative overflow-hidden" data-aos="fade-up">
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div data-aos="fade-right">
                <span class="text-xs uppercase tracking-[0.25em] text-emerald-600 font-bold">Digital Payments</span>
                <h2 class="text-3xl md:text-4xl font-extrabold text-slate-950 mt-3 font-sans">MECOSA Merchant Pay Services</h2>
                <p class="text-slate-600 mt-4 leading-relaxed">Accept and make payments seamlessly through our merchant payment platform. Available on both MTN Mobile Money and Airtel Money for instant, secure transactions.</p>
                <div class="mt-8 space-y-4">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-slate-700 text-sm"><strong>Instant Transactions</strong> &mdash; Real-time payment processing</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 bg-yellow-100 rounded-full flex items-center justify-center flex-shrink-0">
                            <svg class="w-4 h-4 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        </div>
                        <span class="text-slate-700 text-sm"><strong>Secure Payments</strong> &mdash; Encrypted and safe transactions</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 bg-yellow-100 rounded-full flex items-center justify-center flex-shrink-0">
                            <svg class="w-4 h-4 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                        </div>
                        <span class="text-slate-700 text-sm"><strong>MTN &amp; Airtel</strong> &mdash; Works on both networks</span>
                    </div>
                </div>
                <a href="{{ route('contact') }}" class="site-btn-primary mt-8 inline-block text-sm">Get Started</a>
            </div>
            <div class="bg-emerald-50 rounded-3xl p-8 md:p-10 border border-emerald-100" data-aos="fade-left">
                <div class="text-center">
                    <div class="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-8 h-8 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>
                    </div>
                    <h3 class="text-xl font-extrabold text-emerald-800 font-sans">Merchant Pay</h3>
                    <p class="text-slate-600 text-sm mt-2">Accept payments from members and customers via mobile money platforms</p>
                    <div class="flex items-center justify-center gap-4 mt-6">
                        <div class="bg-yellow-500 text-white px-4 py-2 rounded-lg font-bold text-sm">MTN MoMo</div>
                        <div class="bg-red-600 text-white px-4 py-2 rounded-lg font-bold text-sm">Airtel Money</div>
                    </div>
                </div>
            </div>
        </div>
