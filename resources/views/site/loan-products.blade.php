...
<section class="page-header">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <h1>Loan Products</h1>
        <p class="text-green-100 mt-2 max-w-2xl">Kasambya SACCO offers a variety of loan products to support members in business, development, and meeting personal financial needs.</p>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse($loanProducts as $product)
                <div class="bg-white border border-gray-200 p-8 hover:shadow-md transition-shadow hover:border-green-500">
                    <div class="w-14 h-14 bg-green-100 flex items-center justify-center mb-4">
...
<section class="py-16 bg-green-700 text-white text-center">
    <div class="max-w-3xl mx-auto px-4">
        ...
        <p class="text-green-100 mb-8">Contact us today to learn more about our loan products and how to apply.</p>
        <a href="{{ route('application') }}" class="inline-block bg-white text-green-800 font-bold px-10 py-3 hover:bg-green-50 transition-colors">Apply Now</a>
    </div>
</section>
