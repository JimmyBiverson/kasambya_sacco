...
<head>
    ...
    @if(!empty($socialImage))
        <meta property="og:image" content="{{ url(Storage::url($socialImage)) }}" />
        <meta name="twitter:image" content="{{ url(Storage::url($socialImage)) }}" />
    @endif
...
<body class="font-sans antialiased bg-white text-gray-900 dark:bg-slate-900 dark:text-slate-200 transition-colors duration-200" style="--theme-primary: {{ $theme_primary_value ?? '#10b981' }}; --theme-secondary: {{ $theme_secondary_value ?? '#06b6d4' }}; --theme-accent: {{ $theme_accent_value ?? '#facc15' }}; --theme-primary-contrast: #ffffff; --theme-secondary-contrast: #ffffff; --theme-accent-contrast: #0f172a; --theme-nav: var(--theme-primary); --theme-footer: var(--theme-secondary);">
            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="flex items-center justify-between h-16">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        @endif
                        <button @click="mobileOpen = !mobileOpen" class="lg:hidden p-2 rounded-md text-gray-600 hover:text-theme-primary">
            ...
            <div x-show="mobileOpen" class="lg:hidden border-t border-gray-200 bg-white" x-cloak>
                <div class="px-4 py-3 space-y-1">
                    ...
                    <div x-data="{ aboutOpen: false }">
                        <button @click="aboutOpen = !aboutOpen" class="flex items-center justify-between w-full py-2 text-gray-700 font-medium hover:text-theme-primary">
                            ABOUT
                    ...
                    <div x-data="{ productsOpen: false }">
                        <button @click="productsOpen = !productsOpen" class="flex items-center justify-between w-full py-2 text-gray-700 font-medium hover:text-theme-primary">
                            PRODUCTS & SERVICES
                        ...
                        <div x-show="productsOpen" class="pl-4 space-y-1 pb-2">
                            ...
                            <a href="{{ route('services') }}" class="block py-1.5 text-sm text-gray-600 hover:text-theme-primary">Our Services</a>
                            <div class="text-xs font-semibold text-gray-500 mt-1">Loan Products</div>
                            <a href="{{ route('loan-products') }}" class="block py-1.5 text-sm text-gray-600 hover:text-theme-primary">Loan Products</a>
                            <a href="{{ route('msacco') }}" class="block py-1.5 text-sm text-gray-600 hover:text-theme-primary">M-SACCO Services</a>
                        </div>
                    </div>
                    ...
                    @else
                        <a href="{{ route('member.login') }}" class="block py-2 text-center text-sm text-gray-600 hover:text-theme-primary mt-2">Member Login</a>
                    @endif
                </div>
            </div>
        </header>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="{{ route('application') }}" class="text-theme-accent hover:text-white transition-colors">Apply for Loan</a></li>
                            <li><a href="{{ route('news') }}" class="text-theme-accent hover:text-white transition-colors">News & Events</a></li>
                            <li><a href="{{ route('history') }}" class="text-theme-accent hover:text-white transition-colors">Our History</a></li>
                            <li><a href="{{ route('reports') }}" class="text-theme-accent hover:text-white transition-colors">Financial Reports</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-2 text-sm">
                            <li><a href="{{ route('services') }}" class="text-theme-accent hover:text-white transition-colors">Group Account</a></li>
                            <li><a href="{{ route('services') }}" class="text-theme-accent hover:text-white transition-colors">Individual Account</a></li>
                            <li><a href="{{ route('services') }}" class="text-theme-accent hover:text-white transition-colors">Institutional Account</a></li>
                            <li><a href="{{ route('services') }}" class="text-theme-accent hover:text-white transition-colors font-medium">View All Account Types</a></li>
                        </ul>
                        <h3 class="text-white font-semibold mt-6 mb-4 text-sm uppercase tracking-wider">Loan Products</h3>
                        <ul class="space-y-2 text-sm">
                            <li><a href="{{ route('loan-products') }}" class="text-theme-accent hover:text-white transition-colors">Agriculture Loan</a></li>
                            <li><a href="{{ route('loan-products') }}" class="text-theme-accent hover:text-white transition-colors">Transport Loan</a></li>
                            <li><a href="{{ route('loan-products') }}" class="text-theme-accent hover:text-white transition-colors">Housing Loan</a></li>
                            <li><a href="{{ route('loan-products') }}" class="text-theme-accent hover:text-white transition-colors font-medium">All Loan Products</a></li>
                        </ul>
                    </div>
    ...
    <style>
        ...
        /* legacy dark-mode override removed; use theme-friendly CSS instead */
