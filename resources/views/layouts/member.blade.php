...
<head>
    ...
    <title>@yield('title', 'Dashboard') — Member | Kasambya SACCO</title>
    <meta name="description" content="Kasambya SACCO Member Portal">
...
<body class="font-sans antialiased text-slate-800 bg-slate-100 dark:bg-slate-900 dark:text-slate-200 transition-colors duration-200">
        ...
        <aside :class="{'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen}" class="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-slate-950 text-slate-700 dark:text-slate-300 border-r border-slate-200 dark:border-slate-800 transform -translate-x-full lg:translate-x-0 transition-transform duration-200 ease-in-out lg:static lg:z-auto flex flex-col shadow-xl">
            ...
            <div class="flex items-center justify-between h-16 px-5 border-b border-slate-200 dark:border-slate-800">
                <a href="{{ route('member.dashboard') }}" class="flex items-center space-x-3">
                    <div class="w-9 h-9 bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-lg flex items-center justify-center text-white font-bold text-sm shadow-lg shadow-emerald-500/20">KS</div>
                    <div>
                        <div class="text-slate-800 dark:text-slate-200 font-bold text-sm leading-tight">Kasambya</div>
                        <div class="text-emerald-600 text-[10px] leading-tight -mt-0.5 tracking-wider uppercase font-semibold">Member Portal</div>
                    </div>
                </a>
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-0.5">
                ...
                <a href="{{ route('member.dashboard') }}" class="group flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 {{ request()->routeIs('member.dashboard') ? 'bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 shadow-sm border border-emerald-200 dark:border-emerald-800' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/50' }}">
                ...
                <div class="space-y-0.5">
                    <a href="{{ route('member.savings') }}" class="group flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 {{ request()->routeIs('member.savings') ? 'bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 shadow-sm border border-emerald-200 dark:border-emerald-800' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/50' }}">
                    ...
                    <a href="{{ route('member.open-savings') }}" class="group flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 {{ request()->routeIs('member.open-savings') ? 'bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 shadow-sm border border-emerald-200 dark:border-emerald-800' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/50' }}">
                    ...
                    <a href="{{ route('member.loans') }}" class="group flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 {{ request()->routeIs('member.loans') ? 'bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 shadow-sm border border-emerald-200 dark:border-emerald-800' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/50' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                        <span>My Loans</span>
                    </a>

                    <a href="{{ route('member.transactions') }}" class="group flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 {{ request()->routeIs('member.transactions') ? 'bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 shadow-sm border border-emerald-200 dark:border-emerald-800' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/50' }}">
                ...
                <div class="space-y-0.5">
                    <a href="{{ route('member.apply-loan') }}" class="group flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 {{ request()->routeIs('member.apply-loan') ? 'bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 shadow-sm border border-emerald-200 dark:border-emerald-800' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/50' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/></svg>
                        <span>Apply for Loan</span>
                    </a>

                    <a href="{{ route('member.msacco') }}" class="group flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 {{ request()->routeIs('member.msacco') ? 'bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 shadow-sm border border-emerald-200 dark:border-emerald-800' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/50' }}">
                    ...
                    <a href="{{ route('member.support') }}" class="group flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 {{ request()->routeIs('member.support') ? 'bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 shadow-sm border border-emerald-200 dark:border-emerald-800' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/50' }}">
                    ...
                    <a href="{{ route('member.documents') }}" class="group flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 {{ request()->routeIs('member.documents') ? 'bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 shadow-sm border border-emerald-200 dark:border-emerald-800' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/50' }}">
                    ...
                    <a href="{{ route('member.profile') }}" class="group flex items-center space-x-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 {{ request()->routeIs('member.profile') ? 'bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-400 shadow-sm border border-emerald-200 dark:border-emerald-800' : 'text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/50' }}">
            ...
            <div class="border-t border-slate-200 dark:border-slate-800 p-4">
                <div class="flex items-center space-x-3">
                    <div class="w-9 h-9 bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-lg flex items-center justify-center text-white font-bold text-sm uppercase shadow-lg">{{ $initials }}</div>
        ...
        <div class="flex-1 flex flex-col h-screen min-w-0">
            ...
            <header class="bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 h-16 flex items-center px-4 lg:px-6 sticky top-0 z-30 shadow-sm flex-shrink-0">
                ...
                <div class="flex items-center space-x-2">
                    <button @click="dark = !dark" class="text-slate-600 dark:text-slate-400 hover:text-amber-500 dark:hover:text-amber-400 p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-all" title="Toggle dark mode">
            ...
            <footer class="border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 px-4 lg:px-6 py-3 flex-shrink-0">
                <div class="flex flex-col sm:flex-row items-center justify-between text-xs text-slate-600 dark:text-slate-400">
                    ...
                    <p class="mt-1 sm:mt-0">Powered by Kasambya SACCO</p>
                </div>
            </footer>
        </div>
    </div>
