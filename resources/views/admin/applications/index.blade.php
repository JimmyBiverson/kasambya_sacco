        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="text-left border-b border-gray-100">
                    ...
                    <th class="pb-3 px-4 font-semibold text-gray-500 text-[11px] uppercase tracking-wider">Account Type</th>
                    <th class="pb-3 px-4 font-semibold text-gray-500 text-[11px] uppercase tracking-wider">Next of Kin</th>
            ...
            <tbody>
                @forelse($applications as $app)
                    <tr id="application-row-{{ $app->id }}" class="border-b border-gray-50 hover:bg-gray-50/80 transition-colors">
                        ...
                        <td class="py-3 px-4 text-gray-500">{{ $app->account_type ?? '—' }}</td>
                        <td class="py-3 px-4 text-gray-500">{{ $app->next_of_kin_name ?? '—' }} <span class="text-xs text-gray-400">{{ $app->next_of_kin_relationship ? '(' . $app->next_of_kin_relationship . ')' : '' }}</span></td>
                        <td class="py-3 px-4">
