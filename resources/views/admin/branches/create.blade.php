    ...
    <form method="POST" action="{{ route('admin.branches.store') }}" class="space-y-5">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="code" value="{{ old('code') }}" required class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm" placeholder="e.g. BR001">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="region" value="{{ old('region') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm">
            </div>
        </div>
        ...
        <div>
            ...
            <input type="text" name="manager_name" value="{{ old('manager_name') }}" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm">
        </div>
        ...
        <div class="flex items-center space-x-3 pt-4 border-t border-gray-100">
            <button type="submit" class="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-lg transition-colors">Create Branch</button>
